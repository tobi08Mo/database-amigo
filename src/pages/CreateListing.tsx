        ...
        <div style={{ maxWidth: 500, margin: "0 auto" }}>
          ...
          <div className="bm-card" style={{ padding: 18 }}>
            <form onSubmit={handleSubmit}>
              ...
              <div className="bm-form-group"><label className="bm-form-label">Kategorie</label><select className="bm-form-input" value={category} onChange={e => setCategory(e.target.value)}>{getCategories().map(c => <option key={c}>{c}</option>)}</select></div>
